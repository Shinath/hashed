...
namespace Hashed {
    ...
    public partial class ModelDataSet : global::System.Data.DataSet {
        ...
        public partial class LinksDataTable : global::System.Data.TypedTableBase<LinksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public LinksRow AddLinksRow(string name, string link, string hash, int id_user) {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow AddUsersRow(string name, string link) {
        ...
        public partial class LinksRow : global::System.Data.DataRow {
            ...
            public string hash {
                get {
                    return ((string)(this[this.tableLinks.hashColumn]));
                }
                set {
                    this[this.tableLinks.hashColumn] = value;
                }
            }
            ...
            public int id_user {
                get {
                    return ((int)(this[this.tableLinks.id_userColumn]));
                }
                set {
                    this[this.tableLinks.id_userColumn] = value;
                }
            }
        }
...
namespace Hashed.ModelDataSetTableAdapters {
    ...
    public partial class LinksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Links] WHERE (([id] = @Original_id) AND ([name] = @Original_na" +
                "me) AND ([hash] = @Original_hash) AND ([id_user] = @Original_id_user))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Links] ([name], [link], [hash], [id_user]) VALUES (@name, @lin" +
                "k, @hash, @id_user);\r\nSELECT id, name, link, hash, id_user FROM Links WHERE (id " +
                "= SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Links] SET [name] = @name, [link] = @link, [hash] = @hash, [id_user] = @id_user WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([hash] = @Original_hash) AND ([id_user] = @Original_id_user));
SELECT id, name, link, hash, id_user FROM Links WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Hashed.Properties.Settings.Default.cn;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, link, hash, id_user FROM dbo.Links";
        ...
        public virtual int Fill(ModelDataSet.LinksDataTable dataTable) {
        ...
        public virtual ModelDataSet.LinksDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ModelDataSet.LinksDataTable dataTable = new ModelDataSet.LinksDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ModelDataSet.LinksDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_hash, int Original_id_user) {
        ...
        public virtual int Insert(string name, string link, string hash, int id_user) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string link, string hash, int id_user, int Original_id, string Original_name, string Original_hash, int Original_id_user, int id) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string link, string hash, int id_user, int Original_id, string Original_name, string Original_hash, int Original_id_user) {
            return this.Update(name, link, hash, id_user, Original_id, Original_name, Original_hash, Original_id_user, Original_id);
        }
    }
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([name], [link]) VALUES (@name, @link);\r\nSELECT id, nam" +
                "e, link FROM Users WHERE (id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@name", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@link", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "link", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Users] SET [name] = @name, [link] = @link WHERE (([id] = @Original_" +
                "id) AND ([name] = @Original_name) AND ([link] = @Original_link));\r\nSELECT id, na" +
                "me, link FROM Users WHERE (id = @id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@name", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@link", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "link", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT id, name, link FROM dbo.Users";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_id, string Original_name, string Original_link) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_id));
            if ((Original_name == null)) {
                throw new global::System.ArgumentNullException("Original_name");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string link, int Original_id, string Original_name, string Original_link, int id) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string link, int Original_id, string Original_name, string Original_link) {
            return this.Update(name, link, Original_id, Original_name, Original_link, Original_id);
        }
    }
